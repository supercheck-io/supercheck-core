...
<Callout type="tip">
All test types support parallel execution and can be included in automated job workflows.
</Callout>
...
<Step> Write your test script in the Monaco editor with syntax highlighting</Step>
...
<Callout type="note">
Tests automatically access project variables and secrets during execution, making them highly configurable and secure.
</Callout>
...
Always mark passwords, API keys, and tokens as secrets to ensure proper encryption and protection.
</Callout>
...
<Callout type="tip">
The AI system maintains a complete audit trail of all interactions for compliance and security purposes.
</Callout>
